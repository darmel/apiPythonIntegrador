...
class TestPeopleApi:
    ...
    def test_verify_new_user_can_be_added(self):
        ...
        #})
        payload = json.dumps(Persona.generate_valid_data(self)) #reemplazamos las lineas comentadas por esta linea que llama al methodo generate new valid user data
